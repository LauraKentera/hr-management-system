...
const AttendanceGraph = () => {
    ...
    // Simulate data fetching from API or use static data
    useEffect(() => {
        const dummyData = [
        ...
        console.log('Dummy Data:', dummyData);  // Log the dummy data
        setData(dummyData);  // Set the dummy data on component mount
