...
INSERT INTO
    AbsenceType (name, code, is_paid, requires_approval)
VALUES
...
VALUES
    (NULL, 'Chief Executive Officer', 'CEO', 5, TRUE),
...
INSERT INTO
    DisabilityCategory (name, legal_code)
VALUES
...
INSERT INTO
    BenefitItem (benefit_id, from_date, amount)
VALUES
    (1, '2023-01-01', 50.00),
    (2, '2023-01-01', 30.00),
    (3, '2023-01-01', 100.00),
...
INSERT INTO
    EmployeeBenefit (employee_id, benefit_id, from_date, amount)
VALUES
